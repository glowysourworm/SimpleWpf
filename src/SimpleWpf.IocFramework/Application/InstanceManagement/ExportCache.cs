...
namespace SimpleWpf.IocFramework.Application.InstanceManagement
{
    internal class ExportCache
    {
        ...
        // Cache of instance factory relationships
        readonly SimpleDictionary<ExportKey, ExportKey> _instanceFactoryDict;
        ...
        internal ExportCache()
        {
            ...
            _instanceFactoryDict = new SimpleDictionary<ExportKey, ExportKey>();
        }
        ...
        internal bool HasInstanceFactory(ExportKey exportKeyOfInstanceToBuild)
        {
            return _instanceFactoryDict.ContainsKey(exportKeyOfInstanceToBuild);
        }
        ...
        internal ExportKey GetExportKey(Export export)
        {
            return _exports.First(pair => pair.Value.Equals(export)).Key;
        }

        internal ExportKey GetInstanceFactoryKey(ExportKey exportKeyOfInstanceToBuild)
        {
            return _instanceFactoryDict[exportKeyOfInstanceToBuild];
        }

        internal void SetInstanceFactoryRelationship(ExportKey exportKeyOfInstanceToBuild, ExportKey exportKeyOfInstanceFactory)
        {
            _instanceFactoryDict.Add(exportKeyOfInstanceToBuild, exportKeyOfInstanceFactory);
        }
