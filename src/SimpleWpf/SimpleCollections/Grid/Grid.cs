...
using SimpleWpf.SimpleCollections.Array2D;
using SimpleWpf.SimpleCollections.Collection;
using SimpleWpf.SimpleCollections.Grid.Interface;

using static SimpleWpf.SimpleCollections.Array2D.Array2DExtension;

namespace SimpleWpf.SimpleCollections.Grid
{
    /// <summary>
